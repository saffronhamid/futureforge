...
function scrap() {
  return (
    <>
      <Head>
        <title>FutureForge | Terms And Conditions</title>
      </Head>
      ...
      <div className="TNCcontainer">
        <div className="front">
          ...
          <div className="maincontent" style={{ display: "inline-block" }}>
            {" "}
            We are FutureForge, doing business as FutureForge (
            ...
            contact.FutureForge@gmail.com, or by mail to Naval Nagar hathras,
            ...
            and FutureForge, concerning your access to and use of the Services. You
            ...
            contact.FutureForge@gmail.com, as stated in the email message. By
        ...
        <div className="terms-and-cond" id="2" style={{ marginTop: 45 }}>
          ...
          <div className="terms-and-cond-sub">
            ...
            to: contact.FutureForge@gmail.com. If we ever grant you the permission
          ...
          <div className="terms-and-cond-sub">
            ...
            FutureForge. Mediator should be FutureForge
          ...
          <div className="terms-and-cond-sub">
            ...
            Policy: https://www.FutureForge.in/privacy. By using the Services, you
          ...
          <div className="terms-and-cond-sub">
            ...
            laws of India. FutureForge and yourself irrevocably consent that the
          ...
          <div className="terms-and-cond-sub">
            ...
            contact.FutureForge@gmail.com<br></br>
          </div>
        </div>
      </div>
      <Footer />
