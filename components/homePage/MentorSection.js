...
function MentorSection() {
  return (
    <Section
      ...
      kicker="be a mentor at FutureForge"
      heading="Why to be Mentor at FutureForge?"
      ...
      <div className="tw-relative tw-w-full tw-max-w-sm tw-mx-auto tw-space-y-4">
        ...
        <div className="tw-relative tw-z-10 tw-grid tw-gap-4">
          <ProfileCard
            ...
            heading="Faizan Hamid"
            subheading="Google Summer of Code Mentor"
            body="Great Experience mentoring students on FutureForge"
            intent="bg"
            rounded="sm"
          />
          <ProfileCard
            ...
            image="https://media.cssninja.io/shuriken/avatars/2.svg"
            heading="Ijlal Furqaan"
            subheading="ISRO Mentor"
            body="Mentoring students on FutureForge was a fulfilling and rewarding experience."
            intent="bg"
            rounded="sm"
            direction="row-reverse"
          />
          <ProfileCard
            className="tw-shadow-none tw-mr-8"
            image="https://media.cssninja.io/shuriken/avatars/2.svg"
            heading="Salman Hamid"
            subheading="Amazon ML Summer Mentor"
            body="I gained valuable insights while mentoring students on FutureForge."
            intent="bg"
            rounded="sm"
          />
        </div>
